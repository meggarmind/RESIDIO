/** Applies tracker-confirmed IBB 25–27 move-in dates without changing existing roles. */
...
const cases = [
  { house_number: '25', move_in_date: '2022-12-01' },
  { house_number: '26F-1', move_in_date: '2018-10-01' },
  { house_number: '26F-2', move_in_date: '2020-07-01' },
  { house_number: '26F-4', move_in_date: '2023-02-01' },
  { house_number: '27', move_in_date: '2015-01-01' },
];
async function main() {
