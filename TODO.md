...
- [x] **#147 Final unsafe-type/directive/JSX cleanup:** `npm run lint` passes with zero errors; Vitest passes 361/361; production build passes with the existing root `.env.local` loaded for Supabase prerendering. Issue review/merge lifecycle remains pending.
