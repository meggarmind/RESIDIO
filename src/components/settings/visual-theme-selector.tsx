...
import { getThemesGroupedByCategory } from '@/lib/themes/registry';
import type { VisualTheme, ThemeCategory } from '@/lib/themes/types';
    ...
    >
      ...
      <div className="flex gap-1">
        ...
        <div className="flex-1 h-8 rounded-l-md overflow-hidden flex">
          <div
            className="flex-1"
            style={{ backgroundColor: theme.light.bg.primary }}
            title="Light Background"
          />
          <div
            className="flex-1"
            style={{ backgroundColor: theme.dark.bg.primary }}
