 ...
 *
 * Uses AES-256-GCM for encrypting Gmail OAuth tokens and bank account passwords.
...
function getEncryptionKey(): Buffer {
  const keyHex = process.env.GMAIL_TOKEN_ENCRYPTION_KEY;
 ...
 * Use this to create the GMAIL_TOKEN_ENCRYPTION_KEY value.
