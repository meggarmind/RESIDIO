...
VALUES
  ...
  (
    'uu000001-0001-0001-0001-000000000001'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000002'::uuid,
    'resident',
    'aa000001-0001-0001-0001-000000000002'::uuid,
  ...
  (
    'uu000001-0001-0001-0001-000000000003'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000004'::uuid,
    'resident',
    'aa000001-0001-0001-0001-000000000003'::uuid,
  ...
  (
    'uu000001-0001-0001-0001-000000000005'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000006'::uuid,
    'resident',
    'aa000001-0001-0001-0001-000000000005'::uuid,
  ...
  (
    'uu000001-0001-0001-0001-000000000007'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000008'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000009'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000010'::uuid,
    'resident',
    'aa000001-0001-0001-0001-000000000020'::uuid,
  ...
  (
    'uu000001-0001-0001-0001-000000000011'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000012'::uuid,
    'resident',
    'aa000001-0001-0001-0001-000000000025'::uuid,
  ...
  (
    'uu000001-0001-0001-0001-000000000013'::uuid,
    'resident',
  ...
  -- RES035: Caretaker
  (
    'uu000001-0001-0001-0001-000000000014'::uuid,
    'resident',
  ...
  -- RES040: New resident
  (
    'uu000001-0001-0001-0001-000000000015'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000016'::uuid,
    'resident',
    'aa000001-0001-0001-0001-000000000040'::uuid,
  ...
  (
    'uu000001-0001-0001-0001-000000000017'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000018'::uuid,
    'resident',
    'aa000001-0001-0001-0001-000000000045'::uuid,
  ...
  (
    'uu000001-0001-0001-0001-000000000019'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000020'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000021'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000022'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000023'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000024'::uuid,
    'resident',
  ...
  (
    'uu000001-0001-0001-0001-000000000025'::uuid,
    'resident',
  ...
  -- OAK-01
  (
    'uu000001-0001-0001-0001-000000000026'::uuid,
    'house',
  ...
  -- OAK-02
  (
    'uu000001-0001-0001-0001-000000000027'::uuid,
    'house',
  ...
  -- OAK-05 (Duplex)
  (
    'uu000001-0001-0001-0001-000000000028'::uuid,
    'house',
  ...
  -- PALM-03
  (
    'uu000001-0001-0001-0001-000000000029'::uuid,
    'house',
  ...
  -- PALM-05
  (
    'uu000001-0001-0001-0001-000000000030'::uuid,
    'house',
  ...
  -- PALM-08 (Vacant)
  (
    'uu000001-0001-0001-0001-000000000031'::uuid,
    'house',
  ...
  (
    'uu000001-0001-0001-0001-000000000032'::uuid,
    'house',
  ...
  -- CED-01
  (
    'uu000001-0001-0001-0001-000000000033'::uuid,
    'house',
  ...
  -- CED-03
  (
    'uu000001-0001-0001-0001-000000000034'::uuid,
    'house',
  ...
  (
    'uu000001-0001-0001-0001-000000000035'::uuid,
    'house',
  ...
  (
    'uu000001-0001-0001-0001-000000000036'::uuid,
    'house',
  ...
  -- Commercial unit
  (
    'uu000001-0001-0001-0001-000000000037'::uuid,
    'house',
  ...
  (
    'uu000001-0001-0001-0001-000000000038'::uuid,
    'house',
    'bb000001-0001-0001-0001-000000000026'::uuid,
  ...
  -- OAK-08
  (
    'uu000001-0001-0001-0001-000000000039'::uuid,
    'house',
  ...
  -- PALM-01
  (
    'uu000001-0001-0001-0001-000000000040'::uuid,
    'house',
...
DECLARE
  ...
  v_public INT;
BEGIN
  SELECT COUNT(*) INTO v_total FROM entity_notes WHERE id::text LIKE 'uu000001%';
  SELECT COUNT(*) INTO v_resident_notes FROM entity_notes WHERE id::text LIKE 'uu000001%' AND entity_type = 'resident';
  SELECT COUNT(*) INTO v_house_notes FROM entity_notes WHERE id::text LIKE 'uu000001%' AND entity_type = 'house';

  SELECT COUNT(*) INTO v_general FROM entity_notes WHERE id::text LIKE 'uu000001%' AND category = 'general';
  SELECT COUNT(*) INTO v_financial FROM entity_notes WHERE id::text LIKE 'uu000001%' AND category = 'financial';
  SELECT COUNT(*) INTO v_legal FROM entity_notes WHERE id::text LIKE 'uu000001%' AND category = 'legal';
  SELECT COUNT(*) INTO v_maintenance FROM entity_notes WHERE id::text LIKE 'uu000001%' AND category = 'maintenance';
  SELECT COUNT(*) INTO v_security FROM entity_notes WHERE id::text LIKE 'uu000001%' AND category = 'security';

  SELECT COUNT(*) INTO v_confidential FROM entity_notes WHERE id::text LIKE 'uu000001%' AND is_confidential = true;
  SELECT COUNT(*) INTO v_public FROM entity_notes WHERE id::text LIKE 'uu000001%' AND is_confidential = false;
